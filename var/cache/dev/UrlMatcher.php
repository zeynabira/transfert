...
return [
    ...
    [ // $staticRoutes
        ...
        '/login_check' => [
            [['_route' => 'auth', '_controller' => 'App\\Controller\\AuthController::registre'], null, null, null, false, false, null],
            [['_route' => 'login_check'], null, ['POST' => 0], null, false, false, null],
        ],
        '/api/creation_compte' => [[['_route' => 'creation_compte', '_controller' => 'App\\Controller\\CreationCompteController'], null, ['POST' => 0], null, false, false, null]],
    ...
    [ // $dynamicRoutes
        ...
        383 => [[['_route' => 'api_comptes_get_collection', '_controller' => 'api_platform.action.get_collection', '_format' => null, '_api_resource_class' => 'App\\Entity\\Compte', '_api_collection_operation_name' => 'get'], ['_format'], ['GET' => 0], null, false, true, null]],
        420 => [
